                    ...
                    <table class="w-full text-xs text-left text-gray-500 dark:text-gray-400">
                        ...
                        @foreach($registrotermoformados as $registrotermoformado)
                                <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700 uppercase">
                                    ...
                                    <td scope="row" class="px-6 py-4 font-semibold text-xs text-black whitespace-nowrap dark:text-white">{{ $registrotermoformado->producto->nombre}}</td>
                                    ...
                                    <td scope="row" class="px-6 py-4 font-semibold text-xs text-black whitespace-nowrap dark:text-white">{{ $registrotermoformado->piezas_malas_nuevo}}</td>
                                    <td scope="row" class="px-6 py-4 font-semibold text-xs text-black whitespace-nowrap dark:text-white">{{ $registrotermoformado->tiempo_muerto_operador}}</td>
                                    <td scope="row" class="px-6 py-4 font-semibold text-xs text-black whitespace-nowrap dark:text-white">{{ $registrotermoformado->tiempo_muerto_mantenimiento}}</td>
