...
<html>
    <head>
        ...
        <title>RC Tools - Registro termo formado</title>
    </head>
    ...
    <body class="bg-gray-300">
        <div>
            <h1 class="mt-14 ml-20 mb-4 text-6xl font-extrabold leading-none tracking-tight text-gray-900">REGISTRO<mark class="px-2 text-white bg-red-700 rounded ml-3">Termo Formado</mark></h1>

            <div class="mt-12 mr-20 flex flex-row justify-end">
                <a href="registrotermoformado/create" class="text-white bg-green-700 hover:bg-green-800 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-3 py-2.5 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 mr-2 mb-2">
                    ...
                    <table class="w-full text-xs text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-black uppercase bg-blue-300 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                ...
                                <th scope="col" class="px-6 py-3">
                                    PIEZAS MALAS NUEVO MOLDE / MATERIA PRIMA
                                </th>
                                <th scope="col" class="px-6 py-3">
                                    TIEMPO MUERTO OP
                                </th>
                        ...
                        <tbody>
                            @foreach($registrotermoformados as $registrotermoformado)
                                <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700 uppercase">
                                    <th scope="row" class="px-6 py-4 font-medium text-gray-700 whitespace-nowrap dark:text-white">{{ $registrotermoformado->id }}</th>
                                    <td scope="row" class="px-6 py-4 font-medium text-gray-700 whitespace-nowrap dark:text-white">{{ $registrotermoformado->nombreop}}</td>
                                    <td scope="row" class="px-6 py-4 font-medium text-gray-700 whitespace-nowrap dark:text-white">{{ $registrotermoformado->maquina}}</td>
                                    <td scope="row" class="px-6 py-4 font-medium text-gray-700 whitespace-nowrap dark:text-white">{{ $registrotermoformado->fecha}}</td>
                                    <td scope="row" class="px-6 py-4 font-medium text-gray-700 whitespace-nowrap dark:text-white">{{ $registrotermoformado->turno}}</td>
                                    <td scope="row" class="px-6 py-4 font-medium text-gray-700 whitespace-nowrap dark:text-white">{{ $registrotermoformado->producto}}</td>
                                    <td scope="row" class="px-6 py-4 font-medium text-gray-700 whitespace-nowrap dark:text-white">{{ $registrotermoformado->pzsbuenas}}</td>
                                    <td scope="row" class="px-6 py-4 font-medium text-gray-700 whitespace-nowrap dark:text-white">{{ $registrotermoformado->pzsmalas}}</td>
                                    <td scope="row" class="px-6 py-4 font-medium text-gray-700 whitespace-nowrap dark:text-white">{{ $registrotermoformado->pzasmalasnuevo}}</td>
                                    <td scope="row" class="px-6 py-4 font-medium text-gray-700 whitespace-nowrap dark:text-white">{{ $registrotermoformado->tiempoop}}</td>
                                    <td scope="row" class="px-6 py-4 font-medium text-gray-700 whitespace-nowrap dark:text-white">{{ $registrotermoformado->tiempomtto}}</td>
                                    <td scope="row" class="px-6 py-4 font-medium text-gray-700 whitespace-nowrap dark:text-white">{{ $registrotermoformado->causa}}</td>
                                    <td scope="row" class="px-6 py-4 font-medium text-gray-700 whitespace-nowrap dark:text-white">{{ $registrotermoformado->limpieza}}</td>
                                    
                                    <td>
                                        <form action="{{ route ('registrotermoformado.destroy',$registrotermoformado->id)}}" method="POST">
                                            <a href="/registrotermoformado/{{ $registrotermoformado->id }}/edit" class="text-white flex bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 mt-2 py-2.5 mr-2 w-16">
