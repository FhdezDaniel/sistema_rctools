        ...
        <div>
            ...
            <div class="mt-12 mr-20 flex flex-row justify-end">
                ...
                <svg class="w-6 h-6 text-white dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <span class="ml-2">NUEVO REGISTRO TERMO FORMADO</span>
                </a> 
                @endrole
                        ...
                        <tbody>
                            @foreach($registrotermoformados as $registrotermoformado)
                                <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700 uppercase">
                                    ...
                                    <td scope="row" class="px-6 py-4 font-semibold text-xs text-black whitespace-nowrap dark:text-white">{{ $registrotermoformado->nombreop}}</td>
                                    ...
                                    <td scope="row" class="px-6 py-4 font-semibold text-xs text-black whitespace-nowrap dark:text-white">{{ $registrotermoformado->pzsbuenas}}</td>
                                    <td scope="row" class="px-6 py-4 font-semibold text-xs text-black whitespace-nowrap dark:text-white">{{ $registrotermoformado->pzsmalas}}</td>
                                    <td scope="row" class="px-6 py-4 font-semibold text-xs text-black whitespace-nowrap dark:text-white">{{ $registrotermoformado->pzasmalasnuevo}}</td>
                                    <td scope="row" class="px-6 py-4 font-semibold text-xs text-black whitespace-nowrap dark:text-white">{{ $registrotermoformado->tiempoop}}</td>
                                    <td scope="row" class="px-6 py-4 font-semibold text-xs text-black whitespace-nowrap dark:text-white">{{ $registrotermoformado->tiempomtto}}</td>
                                    <td scope="row" class="px-6 py-4 font-semibold text-xs text-black whitespace-nowrap dark:text-white">{{ $registrotermoformado->causa}}</td>
                                    <td scope="row" class="px-6 py-4 font-semibold text-xs text-black whitespace-nowrap dark:text-white">{{ $registrotermoformado->limpieza}}</td>
