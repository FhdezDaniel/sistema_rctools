            ...
            <form action="/registroprensa/{{ $registroprensa->id }}" method="POST">
                ...
                @method('PUT')
                    ...
                    <div class="flex">
                                ...
                                <div class="mb-5 ml-4 w-1/4">
                                    ...
                                    <input
                                        ...
                                        @enderror"
                                        value="{{ $registroprensa->pzsbuenas }}"
                                    />
                                    @error('pzsbuenas')
                                        <p class="bg-red-500 text-white my-2 rounded-lg text-sm p-2 text-center">{{ $message }}</p>
                                    @enderror
                    ...
                    <div class="flex">
                                <div class="mb-5 w-3/4 ml-4">
                                    ...
                                    <input
                                        ...
                                        @enderror"
                                        value="{{ $registroprensa->observaciones }}"
                                    />
                                    @error('causa')
                                        <p class="bg-red-500 text-white my-2 rounded-lg text-sm p-2 text-center">{{ $message }}</p>
                                    @enderror
                    ...
                    <div class="mb-2 flex flex-row justify-end">
                        <a href="/registroprensa" class="text-white bg-red-500 hover:bg-red-700 focus:ring-4 focus:ring-red-400 font-bold uppercase rounded-lg  px-20 py-3 mr-3 ">
                            Cancelar
                        </a>
                        <input 
                            type="submit"
