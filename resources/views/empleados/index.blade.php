...
<html>
    ...
    <body class="bg-gray-300">
        <div>
            <h1 class="mt-20 ml-20 mb-4 text-6xl font-extrabold leading-none tracking-tight text-gray-900"><mark class="px-2 text-white bg-red-700 rounded ml-3">Empleados</mark></h1>
