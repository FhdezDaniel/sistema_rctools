...
<html>
    <head>
        ...
        <title>RC Tools - Crear nuevo registro cajas</title>
    </head>
    ...
    <body class="bg-gray-300">
            <div>
                <h2 class="mt-10 ml-20 mb-8 text-4xl font-extrabold leading-none tracking-tight text-gray-900 ">CREAR REGISTRO de<mark class="px-2 text-white bg-red-700 rounded ml-3">Caja</mark></h2>
            </div>
            <div class="w-4/12 h-2/3  ml-20 bg-white p-6 rounded-lg shadow-xl ">
                <form action="/cajas" method="POST">
                    ...
                    <div class="mb-2">
                        <a href="/cajas" class="text-white bg-red-500 hover:bg-red-700 focus:ring-4 focus:ring-red-400 font-bold uppercase rounded-lg  px-20 py-3 mr-3 ">
                            Cancelar
                        </a>
                        <input 
                            type="submit"
