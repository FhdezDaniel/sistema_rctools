...
<html>
    ...
    <body class="bg-gray-300">
        <div class="w-screen">
            <div>   
                <h1 class="mt-14 ml-20 mb-4 text-5xl font-extrabold leading-none tracking-tight text-gray-900">PRODUCCION <mark class="px-2 text-white bg-red-700 rounded">LINEAS</mark></h1>
