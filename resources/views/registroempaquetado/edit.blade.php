...
<html>
    <head>
        ...
        <title>RC Tools - Editar registro empaquetado</title>
    </head>
                                ...
                                <tr class="border-b bg-white dark:border-neutral-500">
                                    <td class="whitespace-nowrap w-7 px-6 py-4 font-medium">
                                        <input
                                            ...
                                            @enderror"
                                            value="{{ $registroempaquetado->empleado_id }}"
                                        />
                                        @error('empleado_id')
                                    ...
                                    <td class="whitespace-nowrap w-52 px-6 py-4">
                                        <select
                                            id="maquina"
                                            name="maquina" 
                                            type="selected"
                                    ...
                                    <td class="whitespace-nowrap  px-6 py-4">
                                        <input
                                            ...
                                            @enderror"
                                            value="{{ $registroempaquetado->hora }}"
                                            />
                                            @error('hora')
                                                <p class="bg-red-500 text-white my-2 rounded-lg text-sm p-2 text-center">{{ $message }}</p>
                                            @enderror
                                    ...
                                    <td class="whitespace-nowrap  px-6 py-4">
                                        <input
                                            ...
                                            @enderror"
                                            value="{{ $registroempaquetado->fecha }}"
                                            />
                                            @error('fecha')
                                                <p class="bg-red-500 text-white my-2 rounded-lg text-sm p-2 text-center">{{ $message }}</p>
                                            @enderror
                                    ...
                                    <td class="whitespace-nowrap w-44 px-6 py-4">
                                        <select
                                            ...
                                            value="{{ old('linea') }}"
                                        >
                                        <option selected>{{ $registroempaquetado->linea }}</option>
                                    ...
                                    <td class="whitespace-nowrap  px-6 py-4">
                                        <input
                                            ...
                                            class="border-2 font-medium text-black p-3 w-full rounded-lg @error('cajas_rechazadas') border-red-500
                                            @enderror"
                                            value="{{ $registroempaquetado->cajas_rechazadas }}"
                                        />
                                    ...
                                    <td class="whitespace-nowrap  px-6 py-4">
                                        <input
                                            ...
                                            class="border-2 font-medium text-black p-3 w-full rounded-lg @error('total_cajas') border-red-500
                                            @enderror"
                                            value="{{ $registroempaquetado->total_cajas }}"
                                        />
                                            @error('total_cajas')
                                                <p class="bg-red-500 text-white my-2 rounded-lg text-sm p-2 text-center">{{ $message }}</p>
                                            @enderror
                                    ...
                                    <td class="whitespace-nowrap  px-6 py-4">
                                        <input
                                            ...
                                            @enderror"
                                            value="{{ $registroempaquetado->tiempo_muerto_operador }}"
                                        />
                                    ...
                                    <td class="whitespace-nowrap  px-6 py-4">
                                        <input
                                            ...
                                            @enderror"
                                            value="{{ $registroempaquetado->causa }}"
                                        />
                                            @error('causa')
                                                <p class="bg-red-500 text-white my-2 rounded-lg text-sm p-2 text-center">{{ $message }}</p>
                                            @enderror
