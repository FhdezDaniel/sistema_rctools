                    ...
                    <div class="flex">
                                <div class="mb-5 w-3/4">
                                    ...
                                    <input
                                        ...
                                        @enderror"
                                        value="{{ $registroempaquetado->nombreop }}"
                                    />
                                    @error('nombreop')
                    ...
                    <div class="flex">
                                ...
                                <div class="mb-5 ml-4 w-2/4">
                                    ...
                                    <input
                                        ...
                                        @enderror"
                                        value="{{ $registroempaquetado->producto }}"
                                    />
                                    @error('producto')
                                        <p class="bg-red-500 text-white my-2 rounded-lg text-sm p-2 text-center">{{ $message }}</p>
                                    @enderror
                    ...
                    <div class="flex">
                                <div class="mb-5 w-1/4">
                                    ...
                                    <input
                                        ...
                                        @enderror"
                                        value="{{ $registroempaquetado->totalcajas }}"
                                    />
                                    @error('totalcajas')
                                        <p class="bg-red-500 text-white my-2 rounded-lg text-sm p-2 text-center">{{ $message }}</p>
                                    @enderror
