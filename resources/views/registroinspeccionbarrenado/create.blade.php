...
<html>
    ...
    <body class="bg-gray-300">
                <div class="bg-gray-300">
                    <p>.</p>
                    <h1 class="mt-6 ml-20 mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900">CREAR NUEVO REGISTRO<mark class="px-2 text-white bg-red-700 rounded ml-3">Inspección Y Barrenado</mark></h1>
                </div>
                    ...
                    <tr class="border-b bg-white dark:border-neutral-500">
                        ...
                        <td class="whitespace-nowrap  px-6 py-4">
                            <input
                                ...
                                class="border-2 font-medium text-gray-500 p-3 w-full rounded-lg @error('total_piezas') border-red-500
                                @enderror"
                                value="{{ old('total_piezas') }}"
                                />
                                @error('total_piezas')
                                    <p class="bg-red-500 text-white my-2 rounded-lg text-sm p-2 text-center">{{ $message }}</p>
                                @enderror
                        ...
                        <td class="whitespace-nowrap  px-6 py-4">
                            <input
                                ...
                                class="border-2 font-medium text-gray-500 p-3 w-full rounded-lg @error('piezas_malas') border-red-500
                                @enderror"
