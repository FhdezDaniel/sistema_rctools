        ...
        <div>
            ...
            <div class="mt-12 mr-20 flex flex-row justify-end">
                ...
                <a href="registroinspeccionbarrenado/create" class="text-white bg-green-700 hover:bg-green-800 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-3 py-2.5 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 mr-2 mb-2">
                    ...
                    <span class="ml-2">NUEVO REGISTRO INSPECCIÓN Y BARRENADO</span>
                </a>
                @endrole
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        @foreach($registroinspeccionbarrenados as $registroinspeccionbarrenado)
                                <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700 uppercase">
                                    ...
                                    <td scope="row" class="px-6 py-4 font-semibold text-xs text-black whitespace-nowrap dark:text-white">{{ $registroinspeccionbarrenado->producto->nombre}}</td>
                                    ...
                                    <td scope="row" class="px-6 py-4 font-semibold text-xs text-black whitespace-nowrap dark:text-white">{{ $registroinspeccionbarrenado->tiempo_muerto_operador}}</td>
                                    <td scope="row" class="px-6 py-4 font-semibold text-xs text-black whitespace-nowrap dark:text-white">{{ $registroinspeccionbarrenado->causa}}</td>
