...
<html>
    <head>
        ...
        <title>RC Tools - Crear nuevo registro materia prima</title>
    </head>
    ...
    <body class="bg-gray-300">
            <div>
                <h2 class="mt-20 ml-20 mb-8 text-4xl font-extrabold leading-none tracking-tight text-gray-900 ">CREAR REGISTRO de<mark class="px-2 text-white bg-red-700 rounded ml-3">Materia prima</mark></h2>
            </div>
