...
<html>
    <head>
        ...
        <title>RC Tools - Editar registro materia prima</title>
    </head>
    ...
    <body class="bg-gray-300">
            <div>
                <h2 class="mt-20 ml-20 mb-8 text-4xl font-extrabold leading-none tracking-tight text-gray-900 ">EDITAR REGISTRO de<mark class="px-2 text-white bg-red-700 rounded ml-3">Materia prima</mark></h2>
            </div>
            <div class="w-4/12 h-2/3  ml-20 bg-white p-6 rounded-lg shadow-xl ">
            <form action="/materiaprima/{{ $materiaprima->id }}" method="POST">
                @csrf
                @method('PUT')
                    <div class="mb-5">
                    ...
                    <div class="mb-5">
                        <label for="descripcion" class="mb-2 block uppercase text-gray-700 font-bold">
                            Descripcion
                        </label>
                           <input
                                id="descripcion"
                                name="descripcion" 
                                type="text"
                                placeholder="Descripcion de la materia prima"
                                class="border-2 font-medium text-gray-500 p-3 w-full rounded-lg @error('descripcion') border-red-500
                                @enderror"
                    ...
                    <div class="mb-5">
                        <label for="existencia" class="mb-2 block uppercase text-gray-700 font-bold">
                            Existencia
                        </label>
                           <input
                                id="existencia"
                    ...
                    <div class="mb-5">
                        <label for="fecha_registro" class="mb-2 block uppercase text-gray-700 font-bold">
                           ...
                           <input
                                ...
                                @enderror"
                                value="{{ $materiaprima->fecha_registro }}"
                            />
                    ...
                    <div class="mb-2">
                        <a href="/materiaprima" class="text-white bg-red-500 hover:bg-red-700 focus:ring-4 focus:ring-red-400 font-bold uppercase rounded-lg  px-20 py-3 mr-3 ">
                            Cancelar
                        </a>
                        <input 
                            type="submit"
