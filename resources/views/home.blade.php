...
<body class="bg-gray-300">
        <div class="w-screen flex h-3/6">
          <div class="bg-black">
          <h1 class="mt-40 ml-20 mb-4 text-6xl font-extrabold leading-none tracking-tight text-black"><mark class="px-2 text-white bg-red-700 rounded">RC Tools</mark></h1>
              <p class="w-96 p-4 ml-5 text-extrabold text-white text-align">Empresa dedicada al proceso de termo-formado, charolas automotrices y fundas para germinado de planta.</p>
          </div>
          <div class=""> 
        ...
        <h1 class="mt-20 ml-20 mb-4 text-6xl font-extrabold leading-none tracking-tight text-black">Acerca de la <mark class="px-2 text-white bg-red-700 rounded">empresa</mark></h1>
          <div class="flex flex-row bg-gray-300">
            <a href="#" class="ml-20 mt-10 max-w-sm p-6 w-1/4 bg-white border  rounded-lg border-gray-300 shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                ...
                <h5 class="mt-2 mb-2 text-4xl font-bold tracking-tight text-gray-900 dark:text-white">Misión</h5>
                <p class="font-normal text-gray-700 dark:text-gray-400">Crecer como empresa como competidor multinacional en el mercado de termoformados, inspirando orgullo, generando confiabilidad y satisfacción de nuestros clientes.</p>
            </a>
            <a href="#" class="ml-4 mt-10 max-w-sm p-6 w-1/4 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-16 h-16">
                  <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 3v11.25A2.25 2.25 0 006 16.5h2.25M3.75 3h-1.5m1.5 0h16.5m0 0h1.5m-1.5 0v11.25A2.25 2.25 0 0118 16.5h-2.25m-7.5 0h7.5m-7.5 0l-1 3m8.5-3l1 3m0 0l.5 1.5m-.5-1.5h-9.5m0 0l-.5 1.5m.75-9l3-3 2.148 2.148A12.061 12.061 0 0116.5 7.605" />
                </svg>    
                <h5 class="mt-2 mb-2 text-4xl font-bold tracking-tight text-gray-900 dark:text-white">Visión</h5>
                <p class="font-normal text-gray-700 dark:text-gray-400">Ser una empresa líder y reconocida en el mercado nacional de termoformados por su calidad, servicio y diseños innovadores.</p>
            </a>
            <a href="#" class="ml-4 mt-10 max-w-sm p-6 w-1/4 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-16 h-16">
                  <path stroke-linecap="round" stroke-linejoin="round" d="M12 3v17.25m0 0c-1.472 0-2.882.265-4.185.75M12 20.25c1.472 0 2.882.265 4.185.75M18.75 4.97A48.416 48.416 0 0012 4.5c-2.291 0-4.545.16-6.75.47m13.5 0c1.01.143 2.01.317 3 .52m-3-.52l2.62 10.726c.122.499-.106 1.028-.589 1.202a5.988 5.988 0 01-2.031.352 5.988 5.988 0 01-2.031-.352c-.483-.174-.711-.703-.59-1.202L18.75 4.971zm-16.5.52c.99-.203 1.99-.377 3-.52m0 0l2.62 10.726c.122.499-.106 1.028-.589 1.202a5.989 5.989 0 01-2.031.352 5.989 5.989 0 01-2.031-.352c-.483-.174-.711-.703-.59-1.202L5.25 4.971z" />
                </svg>
                <h5 class="mt-2 mb-2 text-4xl font-bold tracking-tight text-gray-900 dark:text-white">Valores</h5>
            ...
            <a href="#" class="ml-4 mt-10 max-w-sm p-6 w-1/4 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                ...
                <h5 class="mt-2 mb-2 text-4xl font-bold tracking-tight text-gray-900 dark:text-white">Politica de calidad</h5>
                <p class="font-normal text-gray-700 dark:text-gray-400">Satisfacer los requerimientos de nuestros clientes, dentro del marco legaly reglamentario vigente, brindando y ofreciendo productos y servicios de calidad en termoformado basados en la mejora continua de nuestros procesos. Para ello contamos con personal competente y consciente de los valores, objetivos y políticas acordes con la estrategia de la organización.</p>
            </a>
          </div>

        <div class="w-screen mt-5 h-20 bg-gray-300 flex flex-col items-center ">
        <form method="get" action="www.facebook.com" class="mt-2">
                <a
                    href="https://www.facebook.com/p/RC-Tools-SA-de-CV-100063620258054/"
                    data-te-ripple-init
          ...
          <p class="text-center font-medium text-black">Norte 11 1129, Ciudad industrial de Celaya, 38010, teléfono: 461-216-0470</p>
        </div>
  </body>
</html>