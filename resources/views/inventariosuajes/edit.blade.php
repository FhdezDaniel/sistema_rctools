...
<html>
    ...
    <body class="bg-gray-300">
            ...
            <form action="/inventariosuajes/{{ $inventariosuajes->id }}" method="POST">
                @csrf
                @method('PUT')
                    <div class="mb-5">
                        ...
                        <input
                            ...
                            @enderror"
                            value="{{ $inventariosuajes->suaje_id }}"
                        />
                        @error('suaje_id')
                    ...
                    <div class="mb-5">
                        ...
                        <input
                            ...
                            @enderror"
                            value="{{ $inventariosuajes->contador_uso }}"
                        />
                        @error('contador_uso')
                            <p class="bg-red-500 text-white my-2 rounded-lg text-sm p-2 text-center">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="mb-5">
                        <label for="fecha_evento" class="mb-2 block uppercase text-gray-700 font-bold">
                            Fecha Evento
                        </label>
                           <input
                                id="fecha_evento"
                                name="fecha_evento" 
                                type="date"
                                placeholder="Fecha registro de evento"
                                class="border-2 font-medium text-gray-500 p-3 w-full rounded-lg @error('fecha_evento') border-red-500
                                @enderror"
                                value="{{ $inventariosuajes->fecha_evento }}"
                            />
                            @error('fecha_evento')
                                <p class="bg-red-500 text-white my-2 rounded-lg text-sm p-2 text-center">{{ $message }}</p>
                            @enderror
                    ...
                    <div class="mb-5">
                        <label for="fecha_baja" class="mb-2 block uppercase text-gray-700 font-bold">
                            Fecha Baja
                        </label>
                           <input
                                id="fecha_baja"
                                name="fecha_baja" 
                                type="date"
                                placeholder="Fecha registro de baja del suaje"
                                class="border-2 font-medium text-gray-500 p-3 w-full rounded-lg @error('fecha_baja') border-red-500
                                @enderror"
                                value="{{ $inventariosuajes->fecha_baja }}"
                            />
                            @error('fecha_baja')
                                <p class="bg-red-500 text-white my-2 rounded-lg text-sm p-2 text-center">{{ $message }}</p>
                            @enderror
                    ...
                    <div class="mb-5">
                        <label for="historial" class="mb-2 block uppercase text-gray-700 font-bold">
                           ...
                           <input
                                ...
                                name="historial" 
                                type="text"
                                placeholder="Registro de historial de eventos"
                                class="border-2 font-medium text-gray-500 p-3 w-full rounded-lg @error('historial') border-red-500
                                @enderror"
                                value="{{ $inventariosuajes->historial }}"
                            />
                            @error('historial')
                                <p class="bg-red-500 text-white my-2 rounded-lg text-sm p-2 text-center">{{ $message }}</p>
                            @enderror
                    ...
                    <div class="mb-2">
                        <a href="/inventariosuajes" class="text-white bg-red-500 hover:bg-red-700 focus:ring-4 focus:ring-red-400 font-bold uppercase rounded-lg  px-20 py-3 mr-3 ">
                            Cancelar
                        </a>
                        <input 
                            type="submit"
