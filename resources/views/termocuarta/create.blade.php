...
<html>
    ...
    <body class="bg-gray-300">
            <div>
                <h2 class="mt-20 ml-24 mb-8 text-4xl font-extrabold leading-none tracking-tight text-gray-900 ">NUEVO REGISTRO PLAN DE <mark class="px-2 text-white bg-red-700 rounded ml-3">Producción Termo 4</mark></h2>
            </div>
