...
<body class="bg-gray-300">
        <div>
            <h2 class="mt-10 ml-20 mb-8 text-4xl font-extrabold leading-none tracking-tight text-gray-900 ">EDITAR REGISTRO PLAN DE <mark class="px-2 text-white bg-red-700 rounded ml-3">Producción Termo 3</mark></h2>
        </div>
        <div class="w-6/12  ml-20 bg-white p-6 rounded-lg shadow-xl flex flex-col">
            <form action="/termotercera/{{ $termotercera->id }}" method="POST">
                @csrf
                @method('PUT')
                <div class="flex">
                ...
                <div class="flex mt-3 ml-80">
                    <div class="mt-3">
                        <a href="/termotercera" class="text-white bg-red-500 hover:bg-red-700 focus:ring-4 focus:ring-red-400 font-bold uppercase rounded-lg px-20 py-3 mr-2 ">
                            Cancelar
                        </a>
                    </div>
                    <div class="">
