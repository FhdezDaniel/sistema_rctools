...
<html>
    ...
    <body class="bg-gray-300">
            ...
            <div class="w-6/12  ml-20 bg-white p-6 rounded-lg shadow-xl flex flex-col">
                <form action="/termoformadoras/{{ $termoformadora->id }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="flex">
                            <div class="mb-5 w-3/5">
                                <label for="termoformadora" class="mb-2 block uppercase text-gray-700 font-bold">
                                    termoformadora
                                </label>
                                <input
                                    id="termoformadora"
                                    name="termoformadora" 
                                    type="text"
                                    class="border-2 font-medium text-gray-500 p-3 w-full rounded-lg @error('termoformadora') border-red-500
                                    @enderror"
                                    value="{{ $termoformadora->termoformadora }}"
                                />
                                @error('termoformadora')
                    ...
                    <div class="flex flex-row justify-end">
                        <div class="mt-3">
                            <a href="/termoformadoras" class="text-white bg-red-500 hover:bg-red-700 focus:ring-4 focus:ring-red-400 font-bold uppercase rounded-lg px-20 py-3 mr-2 ">
                                Cancelar
                            </a>
                        </div>
                        <div class="">
